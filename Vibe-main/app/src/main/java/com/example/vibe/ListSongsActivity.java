...
public class ListSongsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        songsAdapter = new SongsAdapter(this, R.layout.item_song, songArrayList);
        ...
        lvSongs.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent openMusicPlayer = new Intent(ListSongsActivity.this, MusicPlayerActivity.class);
